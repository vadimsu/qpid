...
swig_class SwigClassPn_decimal128_t;
...
swig_class SwigClassPn_bytes_t;
...
swig_class SwigClassPn_class_t;
...
swig_class SwigClassPn_delivery_tag_t;
...
_wrap_pn_delivery_tag_t_size_set(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "pn_delivery_tag_t *","size", 1, self )); 
  }
...
_wrap_pn_delivery_tag_t_bytes_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_pn_delivery_tag_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "pn_delivery_tag_t *","bytes", 1, self )); 
  }
  arg1 = (pn_delivery_tag_t *)(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
SWIGINTERN void
free_pn_delivery_tag_t(pn_delivery_tag_t *arg1) {
    free((char *) arg1);
}
...
swig_class SwigClassPn_atom_t_u;
